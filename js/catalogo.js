...
function crearTarjetaProd(prod) {
  ...
  const categoria = buscarCategoriaPorID(prod.categoria) || {
  ...
  btnAgregarAlCarrito.classList.add(
    "btn",
    "btn-primary",
    "btn-sm",
    "w-100",
...
function filtrarProductos() {
  ...
  let filtrado = listadoProductos.filter((p) =>
